  ...
  <div>
    ...
    <div class="card-grid">
      ...
      <div class="card card-metric" style="border-left-color: #059669;">
        <div>
          ...
          <div class="card-value numeric" style="color: #059669;">{{ standbyMechanicsCount }} / {{ mechanics.length }}</div>
        </div>
        <div style="font-size: 12px; color: var(--text-muted); margin-top: 8px;">
      ...
      <div class="card card-metric" style="border-left-color: #7c3aed;">
        <div>
          ...
          <div class="card-value numeric" style="color: #7c3aed;">Rp {{ formatCurrency(totalRevenue) }}</div>
        </div>
        <div style="font-size: 12px; color: var(--text-muted); margin-top: 8px;">
    ...
    <div class="card" style="margin-bottom: 24px;">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
        <div>
          <h3 style="font-size: 16px; font-weight: 800; color: var(--text-main);">Antrean Servis Aktif & Status Pit</h3>
            ...
            <tr v-if="activeServices.length === 0">
              <td colspan="7">
                <div class="empty-state">
                  ...
                  <div class="empty-state-desc">Tidak ada antrean servis yang sedang berjalan saat ini.</div>
                </div>
              </td>
            </tr>
          </tbody>
