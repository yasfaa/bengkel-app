  ...
  <div>
    ...
    <div class="card" style="margin-bottom: 24px; padding: 0; overflow: hidden;">
      <div style="display: flex; justify-content: space-between; align-items: center; padding: 20px 24px; border-bottom: 1px solid var(--border-subtle);">
        <div>
          <h3 style="font-size: 16px; font-weight: 800; color: var(--text-main);">Master Jasa Servis & Tarif</h3>
          <p style="font-size: 13px; color: var(--text-muted); margin-top: 2px;">Katalog paket jasa servis bengkel yang digunakan saat pembuatan invoice</p>
        </div>
        ...
        <table class="custom-table">
          ...
          <tbody>
            <tr v-for="service in serviceMasters" :key="service.id">
              ...
              <td class="numeric" style="text-align: right; font-weight: 700; color: var(--primary-color);">
              ...
              <td style="text-align: right;">
                <button class="btn btn-secondary" style="padding: 5px 10px; font-size: 12px; margin-right: 6px;" @click="$emit('edit-service-master', service)">
                  <i class="ph-bold ph-pencil-simple"></i> Edit
                </button>
                <button class="btn btn-danger" style="padding: 5px 10px; font-size: 12px;" @click="$emit('delete-service-master', service)">
            ...
            <tr v-if="serviceMasters.length === 0">
              <td colspan="5">
                <div class="empty-state">
                  ...
                  <div class="empty-state-desc">Tambahkan paket jasa servis agar dapat dipilih pada tagihan kasir.</div>
                  <button class="btn btn-primary" @click="$emit('open-service-master-modal')">
                    <i class="ph-bold ph-plus"></i> Tambah Jasa Servis
                  </button>
                </div>
    ...
    <div class="card" style="padding: 0; overflow: hidden;">
      <div style="padding: 20px 24px; border-bottom: 1px solid var(--border-subtle);">
        <h3 style="font-size: 16px; font-weight: 800; color: var(--text-main);">Riwayat Transaksi & Pembayaran</h3>
        <p style="font-size: 13px; color: var(--text-muted); margin-top: 2px;">Daftar invoice dan pembayaran kasir yang tercatat di sistem</p>
      </div>
            ...
            <tr v-if="transactions.length === 0">
              <td colspan="7">
                <div class="empty-state">
                  ...
                  <div class="empty-state-desc">Belum ada pembayaran kasir yang diselesaikan hari ini.</div>
                </div>
              </td>
            </tr>
          </tbody>
